...
{
    Gui.AddPicture("w-1 h-1", A_ScriptDir "\Conf\Skins\" g_SkinConf.BackgroundPicture)
...
Gui.SetFont("C" g_SkinConf.FontColor " S" g_SkinConf.FontSize, g_SkinConf.FontName)
Gui.AddEdit("x" border " y" border " gProcessInputCommand -WantReturn"
...
Gui.AddEdit(y+0 w0 h0 ReadOnly -WantReturn,)
Gui.AddButton(y+0 w0 h0 Default,gRunCurrentCommand)
;Gui, Add, Button, y+0 w0 h0 Default gRunCurrentCommand
Gui.AddEdit("y+" border " -VScroll ReadOnly -WantReturn" . " w" g_SkinConf.WidgetWidth " h" g_SkinConf.DisplayAreaHeight , AlignText(SearchCommand("", true)))
